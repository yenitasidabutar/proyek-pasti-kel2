$(document).ready(function (){
    $.getJSON(baseURL + '/statistik-penduduk/show', function(response) {
        ...
        let pie = {
            ...
            subtitle: {
                text: "Total Jemaat: " + response.totalPenduduk
            },
            plotOptions: {
                series: {
                    dataLabels: {
        ...
        chart_pekerjaan.series[0].setName('Jumlah Jemaat');
    });
});
